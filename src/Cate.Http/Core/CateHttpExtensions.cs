...
namespace Cate.Http.Core
{
    ...
    {
        public static async Task<HttpResponseMessage> GetJsonAsync(this IHttpCate cate, string uri)
        ...
        {
            var body = new JsonBody(cate.Configuration.JsonSerializer.Serialize(data));
        ...
        public static async Task<HttpResponseMessage> DeleteAsync(this IHttpCate cate, string uri)
